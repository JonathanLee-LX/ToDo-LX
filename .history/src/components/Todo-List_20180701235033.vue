<template>
  <el-collapse>
    ...
    <div v-if="todoList.length">
      <el-collapse-item v-for="item in todoList" :title="item.title" :key="item.createAt" style="text-align: left;">
        <template slot="title">
          <el-checkbox v-model="item.done" @change="getDone(item)" class="pull-left" style="margin-right: 10px;">
          </el-checkbox>
          {{item.title}}
